...
- Clean and format CSV / Excel files  
- Fix inconsistent data types and formatting  
- Remove duplicates and invalid entries  
- Standardize categories, dates, and numeric values  
- Merge multi-file datasets into a single usable source  
- Prepare datasets for Power BI, Tableau, or reporting  
- Automate repeat cleaning using Python + Pandas  
...
- Final cleaned data is stored in `/data_clean/`
...
- Freelance data cleaning projects  
